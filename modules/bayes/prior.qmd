...
One thing to note: libraries like [Seaborn](https://seaborn.pydata.org/tutorial/distributions.html) (via the `kdeplot()` function for example) allow you to fit distributions to your data (in this case, using kernel density estimation to 'smooth' the underlying probability density), 
